...
function ZoneCard({
  ...
  return (
    <div
      ...
      onMouseEnter={(e) => {
        (e.currentTarget as HTMLDivElement).style.boxShadow = `0 16px 48px ${glowColor}`;
        (e.currentTarget as HTMLDivElement).style.transform = "translateY(-4px)";
      }}
      onMouseLeave={(e) => {
    ...
    >
      ...
      <h3 className="font-display font-bold text-slate-800 text-base md:text-lg mb-1">
        {name}
      </h3>
      <p className="text-slate-500 text-xs md:text-sm font-body leading-relaxed mb-3">
        {description}
      </p>
...
function StatBlock({
  ...
  return (
    <div className="flex flex-col items-center gap-1">
      ...
      <span className="text-slate-500 text-xs font-body uppercase tracking-widest">
        {label}
      </span>
    </div>
  );
...
function FloatingBadge({
  ...
  return (
    <div
      className="absolute select-none pointer-events-none font-display font-black opacity-[0.18]"
      style={{
        left: x, top: y, color,
        fontSize: size,
        animation: `floatBadge 6s ease-in-out infinite`,
...
export default function WelcomePage() {
  ...
  return (
    <>
      ...
      <div
        className="relative min-h-screen w-full overflow-x-hidden"
        style={{ background: "linear-gradient(135deg, #FFF9F0 0%, #F0FFFE 50%, #F5F0FF 100%)" }}
      >
        {/* ── Noise texture ─────────────────────────────────────────────── */}
        <div className="noise-overlay" aria-hidden="true" />
        ...
        <div
          ...
          style={{
            backgroundImage: `
              linear-gradient(rgba(255,107,157,1) 1px, transparent 1px),
        ...
        {/* ── Corner glows ──────────────────────────────────────────────── */}
        <div className="fixed top-0 left-0 w-96 h-96 pointer-events-none opacity-40"
          style={{ background: "radial-gradient(circle at 0% 0%, rgba(255,213,79,0.6) 0%, transparent 60%)" }}
          aria-hidden="true" />
        <div className="fixed bottom-0 right-0 w-[600px] h-[600px] pointer-events-none opacity-30"
          style={{ background: "radial-gradient(circle at 100% 100%, rgba(108,99,255,0.4) 0%, transparent 60%)" }}
          aria-hidden="true" />
        <div className="fixed top-1/2 right-0 w-64 h-64 pointer-events-none opacity-30"
          style={{ background: "radial-gradient(circle at 100% 50%, rgba(255,107,157,0.4) 0%, transparent 60%)" }}
          aria-hidden="true" />
        ...
        <section className="relative z-10 min-h-screen flex flex-col items-center justify-center px-4 sm:px-6 md:px-8 pt-20 pb-16 text-center">
            ...
            <div className="flex items-center gap-3">
              {!userLoading && user ? (
                ...
                <>
                  <Link
                    href="/login"
                    className="text-slate-500 hover:text-slate-800 text-sm font-body transition-colors px-3 py-1.5"
                  >
                    Login
                  </Link>
                  <Link
          ...
          {/* EYEBROW */}
          <div
            className="mb-4 flex items-center gap-2 px-4 py-1.5 rounded-full border border-pink-300/50"
            style={{
          ...
          >
            <span className="text-xs" style={{ color: "#e0457a" }}>✦</span>
            <span className="text-xs font-body uppercase tracking-widest" style={{ color: "#e0457a" }}>
              The Number Wilds Await
            </span>
            <span className="text-xs" style={{ color: "#e0457a" }}>✦</span>
          </div>
          ...
          <div className="overflow-hidden mb-2">
            <h1
              ...
              style={{
                ...
                letterSpacing: "-0.04em",
                animation: visible ? "titleReveal 0.8s cubic-bezier(0.16,1,0.3,1) 0.3s both" : "none",
                background: "linear-gradient(135deg, #FF6B9D 0%, #FFA500 40%, #6C63FF 100%)",
                backgroundSize: "300% 300%",
                WebkitBackgroundClip: "text",
                WebkitTextFillColor: "transparent",
                backgroundClip: "text",
          ...
          >
            <p
              className="font-display font-bold text-slate-700 max-w-xl mx-auto"
              style={{ fontSize: "clamp(1rem, 3vw, 1.5rem)" }}
            >
              Where{" "}
              <span className="text-teal">mathematical insight</span>{" "}
            ...
            <p className="text-slate-500 text-sm md:text-base font-body mt-2 max-w-md mx-auto">
              Solve puzzles, defeat bosses, earn superpowers — no luck, just
              the pure thrill of thinking faster and more cleverly!
            </p>
          </div>
          ...
          >
            {!userLoading && user ? (
              ...
              <>
                ...
                <Link
                  href="/login"
                  className="flex items-center gap-2 px-8 py-4 rounded-xl font-display font-semibold text-base transition-all duration-200 hover:-translate-y-px"
                  style={{ background: "white", border: "1.5px solid #6C63FF", color: "#6C63FF", minWidth: "180px", justifyContent: "center" }}
                >
                  <span>I have an account</span>
                </Link>
              </>
          ...
          >
            <span className="text-slate-400 text-xs font-body uppercase tracking-widest">
              Explore the world
            </span>
        ...
        ════════════════════════════════════════════════════════════════ */}
        <div
          className="relative z-10 py-4 overflow-hidden border-y border-purple-200/50"
          style={{ background: "linear-gradient(90deg, #FFF0F5 0%, #F0F0FF 100%)" }}
        >
          <div
            className="flex items-center gap-8 whitespace-nowrap"
            style={{ animation: "tickerMove 18s linear infinite", width: "max-content" }}
            ...
            {[...Array(2)].map((_, repeatIdx) => (
              <div key={repeatIdx} className="flex items-center gap-8">
                {[
                  ...
                  <span key={i} className="text-xs font-body uppercase tracking-widest" style={{ color: "rgba(108,99,255,0.7)" }}>
                    {item}
                    <span className="ml-8" style={{ color: "rgba(108,99,255,0.3)" }}>◆</span>
                  </span>
                ))}
              </div>
            ))}
        ...
        <section className="relative z-10 py-12 md:py-20 px-4 sm:px-6 md:px-8">
          <div className="max-w-5xl mx-auto">
            ...
            {/* Section header */}
            <div className="text-center mb-10 md:mb-14">
              <p className="text-xs font-body uppercase tracking-widest mb-3" style={{ color: "#9D4EDD" }}>
                ✦ The World ✦
              </p>
              <h2
              ...
              <p className="text-slate-500 font-body mt-3 max-w-lg mx-auto text-sm md:text-base">
                Three zones, three bosses, twenty-five mathematical superpowers
                waiting to be discovered.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-4 md:mt-5">
              {[
                ...
                <div
                  key={z.n}
                  className="rounded-xl p-5 border border-slate-200 flex items-center gap-4"
                  style={{ background: "rgba(0,0,0,0.02)" }}
                >
                  <div className="w-8 h-8 rounded-full bg-slate-100 flex items-center justify-center text-xs font-display font-black text-slate-300 flex-shrink-0">
                    {z.n}
                  </div>
                  <div>
                    <h3 className="font-display font-bold text-slate-400 text-sm">{z.name}</h3>
                    <p className="text-slate-400 text-xs font-body mt-0.5">{z.desc}</p>
                  </div>
                  <span className="ml-auto text-[10px] font-body text-slate-400 bg-slate-100 px-2 py-1 rounded-full flex-shrink-0">
                    Phase 2
                  </span>
                </div>
              ))}
        ...
        <section className="relative z-10 py-12 md:py-20 px-4 sm:px-6 md:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <p className="text-xs font-body uppercase tracking-widest mb-3" style={{ color: "#7C3AED" }}>
              ✦ The Power System ✦
            </p>
            <h2
              className="font-display font-black text-slate-800 mb-4"
              style={{ fontSize: "clamp(1.8rem, 4.5vw, 3rem)", letterSpacing: "-0.03em" }}
            >
              25 Tricks to{" "}
              <span style={{
            ...
            <p className="text-slate-500 font-body text-sm md:text-base max-w-md mx-auto mb-10">
              Each trick is a deeper view of the same mathematical structure.
              Discover them through play — never taught in a tutorial.
            </p>
            ...
            <div className="flex flex-wrap justify-center gap-2 md:gap-3">
              ...
              <div
                className="px-3 py-2 rounded-full border text-xs font-body text-slate-400 border-slate-200"
        ...
        <section className="relative z-10 py-12 md:py-20 px-4 sm:px-6 md:px-8">
          <div className="max-w-4xl mx-auto">
            <div
              className="rounded-2xl border border-purple-200/60 p-8 md:p-12 text-center relative overflow-hidden"
              style={{ background: "linear-gradient(135deg, #F0F4FF 0%, #FFF0FB 100%)" }}
            >
              {/* Corner decoration */}
              <div
                className="absolute top-0 right-0 w-48 h-48 pointer-events-none"
              ...
              <p className="text-slate-500 font-body text-sm md:text-base max-w-xl mx-auto mb-8">
                Full analytics dashboard, time limits, difficulty controls, personalised
                stories, and custom music. You stay in control — your child stays in flow.
              </p>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
                {[
                  ...
                  <div key={f.label} className="flex flex-col items-center gap-2 p-3 rounded-xl" style={{ background: "rgba(255,255,255,0.7)" }}>
                    <span className="text-2xl">{f.icon}</span>
                    <span className="text-slate-700 font-display font-bold text-sm">{f.label}</span>
                    <span className="text-slate-400 text-xs font-body">{f.desc}</span>
                  </div>
                ))}
              </div>
              ...
              <Link
                href="/signup"
                className="inline-flex items-center gap-2 px-8 py-4 rounded-xl font-display font-black text-white text-base transition-all duration-200 hover:-translate-y-1 hover:opacity-90"
                style={{ background: "linear-gradient(135deg, #6C63FF 0%, #9D4EDD 100%)" }}
              >
                Create Parent Account
                <span>✦</span>
              </Link>
        ...
        <section className="relative z-10 py-16 md:py-28 px-4 sm:px-6 md:px-8 text-center">
          <div className="max-w-3xl mx-auto">
            <p className="text-slate-400 text-xs font-body uppercase tracking-widest mb-6">
              Ready to begin?
            </p>
            <h2
              className="font-display font-black text-slate-800 mb-6"
              style={{ fontSize: "clamp(2.5rem, 8vw, 6rem)", letterSpacing: "-0.04em", lineHeight: 1 }}
            >
              Math is your{" "}
              <span
                style={{
                  background: "linear-gradient(90deg, #FF6B9D, #FFA500, #6C63FF)",
                  backgroundSize: "200%",
                  WebkitBackgroundClip: "text",
                  WebkitTextFillColor: "transparent",
                  backgroundClip: "text",
            ...
            <Link
              href="/signup"
              className="inline-flex items-center gap-3 px-10 py-5 rounded-xl font-display font-black text-white text-xl transition-all duration-200 hover:opacity-90 hover:-translate-y-1"
              style={{
                background: "linear-gradient(135deg, #FF6B9D 0%, #FF8C42 100%)",
                boxShadow: "0 16px 48px rgba(255,107,157,0.35)",
              }}
            >
              Start for Free
        ...
        {/* ── Footer ──────────────────────────────────────────────────────── */}
        <footer
          className="relative z-10 py-8 px-4 sm:px-6 md:px-8 border-t border-slate-200 text-center"
        >
          <div className="flex flex-col sm:flex-row items-center justify-between max-w-4xl mx-auto gap-4">
            <div className="flex items-center gap-2">
              <svg width="20" height="20" viewBox="0 0 48 48" fill="none">
