...
export default function AuthLayout({ children }: AuthLayoutProps) {
  return (
    <main
      ...
      // ── Light warm off-white base ──────────────────────────────────────
      style={{ backgroundColor: "#F8F7F4" }}
    >
      {/* ── Soft warm radial glow — top left ──────────────────────────── */}
      <div
        className="fixed inset-0 z-0"
        style={{
          background:
            "radial-gradient(ellipse at 20% 15%, rgba(232,184,75,0.10) 0%, transparent 55%), " +
            "radial-gradient(ellipse at 80% 85%, rgba(45,212,191,0.07) 0%, transparent 50%)",
        }}
        aria-hidden="true"
      />
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle at 0% 0%, rgba(45,212,191,0.18) 0%, transparent 60%)",
        }}
        aria-hidden="true"
      />
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle at 100% 100%, rgba(124,58,237,0.10) 0%, transparent 60%)",
        }}
        aria-hidden="true"
      />
