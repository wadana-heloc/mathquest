...
const ZONES: ZoneInfo[] = [
  ...
  },
  {
    ...
    tagline: "Division & Advanced Ops",
    emoji: "⚡",
    boss: "Rift Colossus",
    activeBorder: "border-gold",
    activeBg: "bg-gold/10",
    activeGlow: "shadow-[0_0_40px_rgba(232,184,75,0.5)]",
    activeText: "text-gold",
    badgeBg: "bg-gold/20 text-gold border-gold/30",
    difficulty: "Warrior",
    difficultyStars: 3,
  },
  {
    id: 5,
    name: "Dragon's Keep",
    tagline: "Mixed Operations & Mastery",
    emoji: "🐉",
    boss: "Ancient Dragon",
    activeBorder: "border-game-green",
    activeBg: "bg-game-green/10",
    activeGlow: "shadow-[0_0_40px_rgba(34,197,94,0.45)]",
    activeText: "text-game-green",
    badgeBg: "bg-game-green/20 text-game-green border-game-green/30",
    difficulty: "Legend",
    difficultyStars: 3,
  },
];
